// Ported from AlcedoStudio desktop: edit/operators/geometry/lens_calib_runtime.hpp
// SPDX-License-Identifier: GPL-3.0-only
//
// Lensfun-style lens calibration parameter set shared between the CPU
// lens_correction_op and the GLES/Vulkan lens_correction shaders. Carrying
// these in one struct keeps the CPU/GPU parameter layout identical so a
// single fill function can feed both backends.
...
struct LensCalibGpuParams {
    ...
    // Perspective correction (intentionally stubbed, mirrors desktop).
