// AlcedoAndroid - Exposure operator.
...
class ExposureOp : public OperatorBase<ExposureOp>, public PointOpTag {
 public:
  ...
  ExposureOp();
  explicit ExposureOp(float exposure_offset);
  explicit ExposureOp(const nlohmann::json& params);
